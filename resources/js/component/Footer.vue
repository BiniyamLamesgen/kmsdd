...
<template>
    <footer class="relative bg-slate-900 text-white overflow-hidden">
        ...
        <!-- Gradient Overlay -->
        <div
            class="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 opacity-90"
        ></div>

        <div
            class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-6 sm:pb-8"
        >
            <!-- Main Footer Content -->
            <div
                class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-8 sm:mb-12"
            >
                <!-- Brand Section -->
                <div class="sm:col-span-2 lg:col-span-2">
                    ...
                    >
                        ...
                        <div class="text-center sm:text-left">
                            ...
                            >
                                Lemi Kura SubCity Administration
                            </h3>
                    ...
                    >
                        ...
                        collaboration, and accelerate innovation across your
                        teams.
                    </p>
                    ...
                    >
                        ...
                        <div class="flex gap-2 sm:gap-3">
                            <a
                                href="#"
                                class="group relative bg-white/5 hover:bg-blue-500 p-2 sm:p-3 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg"
                                title="LinkedIn"
                            >
                                <svg
                            ...
                            <a
                                href="#"
                                class="group relative bg-white/5 hover:bg-blue-700 p-2 sm:p-3 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg"
                                title="Facebook"
                            >
                                <svg
                                    class="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-white transition-colors"
                                ...
                                >
                                    <path
                                        d="M22.675 0h-21.35C.595 0 0 .592 0 1.326v21.348C0 23.408.595 24 1.326 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.324-.592 1.324-1.326V1.326C24 .592 23.405 0 22.675 0"
                                    />
                                </svg>
                            </a>
                            <a
                                href="#"
                                class="group relative bg-white/5 hover:bg-blue-400 p-2 sm:p-3 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg"
                                title="Twitter"
                            >
                                <svg
                                    class="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-white transition-colors"
                            ...
                            <a
                                href="#"
                                class="group relative bg-white/5 hover:bg-pink-500 p-2 sm:p-3 rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg"
                                title="Instagram"
                            >
                                <svg
                                    class="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-white transition-colors"
                    ...
                    <div class="space-y-3 sm:space-y-4">
                        ...
                        >
                            ...
                            <div class="min-w-0 text-center sm:text-left">
                                ...
                                <a
                                    href="mailto:info@lemikura.com"
                                    class="text-gray-300 hover:text-blue-400 transition-colors font-medium text-sm sm:text-base break-all"
                                >
                                    info@lemikura.com
                                </a>
                            </div>
                        ...
                        >
                            ...
                            <div class="min-w-0 text-center sm:text-left">
                                ...
                                <a
                                    ...
                                    class="text-gray-300 hover:text-green-400 transition-colors font-medium text-sm sm:text-base"
                                >
                                    +251-900-000-000
                                </a>
                            </div>
                        ...
                        >
                            ...
                            <div class="min-w-0 text-center sm:text-left">
                                ...
                                <a
                                    ...
                                    class="text-gray-300 font-medium text-sm sm:text-base hover:text-blue-500 transition-colors"
                                >
                    ...
                    <div class="text-center lg:text-right">
                        <p class="text-white text-xs mb-1 sm:mb-2">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                class="font-semibold text-blue-300 hover:text-cyan-200 transition-colors"
                            >
                                Degan Technologies
                            </a>
                        </p>
